  ...
  fromJSON(object: any): GeneratorParams {
    return {
      ...
      keyMean: isSet(object.keyMean)
        ? globalThis.Number(object.keyMean)
        : isSet(object.key_mean)
        ? globalThis.Number(object.key_mean)
        : 0,
      keyStdDev: isSet(object.keyStdDev)
        ? globalThis.Number(object.keyStdDev)
        : isSet(object.key_std_dev)
        ? globalThis.Number(object.key_std_dev)
        : 0,
      valueMean: isSet(object.valueMean)
        ? globalThis.Number(object.valueMean)
        : isSet(object.value_mean)
        ? globalThis.Number(object.value_mean)
        : 0,
      valueStdDev: isSet(object.valueStdDev)
        ? globalThis.Number(object.valueStdDev)
        : isSet(object.value_std_dev)
        ? globalThis.Number(object.value_std_dev)
        : 0,
      genesisCount: isSet(object.genesisCount)
        ? globalThis.Number(object.genesisCount)
        : isSet(object.genesis_count)
        ? globalThis.Number(object.genesis_count)
        : 0,
