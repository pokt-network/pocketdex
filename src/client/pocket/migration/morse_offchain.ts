  ...
  fromJSON(object: any): MorseStateExport {
    return {
      appHash: isSet(object.appHash)
        ? globalThis.String(object.appHash)
        : isSet(object.app_hash)
        ? globalThis.String(object.app_hash)
        : "",
      appState: isSet(object.appState)
        ? MorseTendermintAppState.fromJSON(object.appState)
        : isSet(object.app_state)
        ? MorseTendermintAppState.fromJSON(object.app_state)
        : undefined,
    };
  },
...
export const MorseApplication: MessageFns<MorseApplication> = {
  ...
  fromJSON(object: any): MorseApplication {
    return {
      ...
      stakedTokens: isSet(object.stakedTokens)
        ? globalThis.String(object.stakedTokens)
        : isSet(object.staked_tokens)
        ? globalThis.String(object.staked_tokens)
        : "",
  ...
  fromJSON(object: any): MorseValidator {
    return {
      ...
      unstakingTime: isSet(object.unstakingTime)
        ...
        ? fromJsonTimestamp(object.unstaking_time)
        : undefined,
      outputAddress: isSet(object.outputAddress)
        ? bytesFromBase64(object.outputAddress)
        : isSet(object.output_address)
        ? bytesFromBase64(object.output_address)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): MorseAccount {
    return {
      ...
      pubKey: isSet(object.pubKey)
        ? MorsePublicKey.fromJSON(object.pubKey)
        : isSet(object.pub_key)
        ? MorsePublicKey.fromJSON(object.pub_key)
        : undefined,
  ...
  fromJSON(object: any): MorseModuleAccount {
    return {
      baseAccount: isSet(object.baseAccount)
        ? MorseAccount.fromJSON(object.baseAccount)
        : isSet(object.base_account)
        ? MorseAccount.fromJSON(object.base_account)
        : undefined,
