 ...
 */
export interface EventMorseAccountRecoveredAdmin {
  ...
  fromJSON(object: any): EventImportMorseClaimableAccounts {
    return {
      createdAtHeight: isSet(object.createdAtHeight)
        ? globalThis.Number(object.createdAtHeight)
        : isSet(object.created_at_height)
        ? globalThis.Number(object.created_at_height)
        : 0,
      morseAccountStateHash: isSet(object.morseAccountStateHash)
        ...
        : new Uint8Array(0),
      numAccounts: isSet(object.numAccounts)
        ? globalThis.Number(object.numAccounts)
        : isSet(object.num_accounts)
        ? globalThis.Number(object.num_accounts)
        : 0,
    };
  },
...
export const EventMorseAccountClaimed: MessageFns<EventMorseAccountClaimed> = {
  ...
  fromJSON(object: any): EventMorseAccountClaimed {
    return {
      sessionEndHeight: isSet(object.sessionEndHeight)
        ? globalThis.Number(object.sessionEndHeight)
        : isSet(object.session_end_height)
        ? globalThis.Number(object.session_end_height)
        : 0,
      ...
      morseSrcAddress: isSet(object.morseSrcAddress)
        ...
        : "",
      claimedBalance: isSet(object.claimedBalance)
        ? globalThis.String(object.claimedBalance)
        : isSet(object.claimed_balance)
        ? globalThis.String(object.claimed_balance)
        : "",
    };
  },
  ...
  fromJSON(object: any): EventMorseApplicationClaimed {
    return {
      ...
      claimedApplicationStake: isSet(object.claimedApplicationStake)
        ...
        : isSet(object.claimed_application_stake)
        ? globalThis.String(object.claimed_application_stake)
        : "",
    };
  },
  ...
  fromJSON(object: any): EventMorseSupplierClaimed {
    return {
      ...
      morseNodeAddress: isSet(object.morseNodeAddress)
        ...
        : "",
      morseOutputAddress: isSet(object.morseOutputAddress)
        ? globalThis.String(object.morseOutputAddress)
        : isSet(object.morse_output_address)
        ? globalThis.String(object.morse_output_address)
        : "",
      claimSignerType: isSet(object.claimSignerType)
        ? morseSupplierClaimSignerTypeFromJSON(object.claimSignerType)
        : isSet(object.claim_signer_type)
        ? morseSupplierClaimSignerTypeFromJSON(object.claim_signer_type)
        : 0,
      claimedSupplierStake: isSet(object.claimedSupplierStake)
        ? globalThis.String(object.claimedSupplierStake)
        : isSet(object.claimed_supplier_stake)
        ? globalThis.String(object.claimed_supplier_stake)
        : "",
  ...
  fromJSON(object: any): EventMorseAccountRecovered {
    return {
      ...
      recoveredBalance: isSet(object.recoveredBalance)
        ? globalThis.String(object.recoveredBalance)
        : isSet(object.recovered_balance)
        ? globalThis.String(object.recovered_balance)
        : "",
      shannonDestAddress: isSet(object.shannonDestAddress)
        ? globalThis.String(object.shannonDestAddress)
        : isSet(object.shannon_dest_address)
...
function createBaseEventMorseAccountRecoveredAdmin(): EventMorseAccountRecoveredAdmin {
  return {
    sessionEndHeight: 0,
    recoveredBalance: "",
    shannonDestAddress: "",
    morseSrcAddress: "",
    isAdminRecovery: false,
  };
}

export const EventMorseAccountRecoveredAdmin: MessageFns<EventMorseAccountRecoveredAdmin> = {
  encode(message: EventMorseAccountRecoveredAdmin, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionEndHeight !== 0) {
      writer.uint32(8).int64(message.sessionEndHeight);
    }
    if (message.recoveredBalance !== "") {
      writer.uint32(18).string(message.recoveredBalance);
    }
    if (message.shannonDestAddress !== "") {
      writer.uint32(26).string(message.shannonDestAddress);
    }
    ...
    if (message.isAdminRecovery !== false) {
      writer.uint32(40).bool(message.isAdminRecovery);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): EventMorseAccountRecoveredAdmin {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEventMorseAccountRecoveredAdmin();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 5: {
          ...
          message.isAdminRecovery = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): EventMorseAccountRecoveredAdmin {
    return {
      sessionEndHeight: isSet(object.sessionEndHeight)
        ? globalThis.Number(object.sessionEndHeight)
        : isSet(object.session_end_height)
      ...
      morseSrcAddress: isSet(object.morseSrcAddress)
        ...
        ? globalThis.String(object.morse_src_address)
        : "",
      isAdminRecovery: isSet(object.isAdminRecovery)
        ? globalThis.Boolean(object.isAdminRecovery)
        : isSet(object.is_admin_recovery)
        ? globalThis.Boolean(object.is_admin_recovery)
        : false,
    };
  },

  toJSON(message: EventMorseAccountRecoveredAdmin): unknown {
    const obj: any = {};
    if (message.sessionEndHeight !== 0) {
      obj.sessionEndHeight = Math.round(message.sessionEndHeight);
    }
    ...
    if (message.isAdminRecovery !== false) {
      obj.isAdminRecovery = message.isAdminRecovery;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<EventMorseAccountRecoveredAdmin>, I>>(base?: I): EventMorseAccountRecoveredAdmin {
    return EventMorseAccountRecoveredAdmin.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventMorseAccountRecoveredAdmin>, I>>(
    object: I,
  ): EventMorseAccountRecoveredAdmin {
    const message = createBaseEventMorseAccountRecoveredAdmin();
    message.sessionEndHeight = object.sessionEndHeight ?? 0;
    ...
    message.shannonDestAddress = object.shannonDestAddress ?? "";
    message.morseSrcAddress = object.morseSrcAddress ?? "";
    message.isAdminRecovery = object.isAdminRecovery ?? false;
    return message;
  },
};
