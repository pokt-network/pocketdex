 ...
 */
export interface MsgAdminRecoverMorseAccount {
  /**
...
export interface MsgAdminRecoverMorseAccountResponse {
}
  ...
  fromJSON(object: any): MsgImportMorseClaimableAccounts {
    return {
      ...
      morseAccountState: isSet(object.morseAccountState)
        ...
        : isSet(object.morse_account_state)
        ? MorseAccountState.fromJSON(object.morse_account_state)
        : undefined,
      morseAccountStateHash: isSet(object.morseAccountStateHash)
        ? bytesFromBase64(object.morseAccountStateHash)
        : isSet(object.morse_account_state_hash)
        ? bytesFromBase64(object.morse_account_state_hash)
        : new Uint8Array(0),
    };
  },
...
export const MsgClaimMorseAccount: MessageFns<MsgClaimMorseAccount> = {
  ...
  fromJSON(object: any): MsgClaimMorseAccount {
    return {
      shannonSigningAddress: isSet(object.shannonSigningAddress)
        ? globalThis.String(object.shannonSigningAddress)
        : isSet(object.shannon_signing_address)
        ? globalThis.String(object.shannon_signing_address)
        : "",
      shannonDestAddress: isSet(object.shannonDestAddress)
        ? globalThis.String(object.shannonDestAddress)
        : isSet(object.shannon_dest_address)
        ? globalThis.String(object.shannon_dest_address)
        : "",
      morsePublicKey: isSet(object.morsePublicKey)
        ? bytesFromBase64(object.morsePublicKey)
        : isSet(object.morse_public_key)
        ? bytesFromBase64(object.morse_public_key)
        : new Uint8Array(0),
      morseSignature: isSet(object.morseSignature)
        ? bytesFromBase64(object.morseSignature)
        : isSet(object.morse_signature)
        ? bytesFromBase64(object.morse_signature)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): MsgClaimMorseApplication {
    return {
      ...
      serviceConfig: isSet(object.serviceConfig)
        ? ApplicationServiceConfig.fromJSON(object.serviceConfig)
        : isSet(object.service_config)
        ? ApplicationServiceConfig.fromJSON(object.service_config)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): MsgClaimMorseSupplier {
    return {
      shannonSigningAddress: isSet(object.shannonSigningAddress)
        ...
        ? globalThis.String(object.shannon_signing_address)
        : "",
      shannonOwnerAddress: isSet(object.shannonOwnerAddress)
        ? globalThis.String(object.shannonOwnerAddress)
        : isSet(object.shannon_owner_address)
        ? globalThis.String(object.shannon_owner_address)
        : "",
      shannonOperatorAddress: isSet(object.shannonOperatorAddress)
        ? globalThis.String(object.shannonOperatorAddress)
        : isSet(object.shannon_operator_address)
        ? globalThis.String(object.shannon_operator_address)
        : "",
      morseNodeAddress: isSet(object.morseNodeAddress)
        ? globalThis.String(object.morseNodeAddress)
        : isSet(object.morse_node_address)
        ? globalThis.String(object.morse_node_address)
        : "",
      morsePublicKey: isSet(object.morsePublicKey)
        ? bytesFromBase64(object.morsePublicKey)
        : isSet(object.morse_public_key)
      ...
      signerIsOutputAddress: isSet(object.signerIsOutputAddress)
        ...
        : isSet(object.signer_is_output_address)
        ? globalThis.Boolean(object.signer_is_output_address)
        : false,
  ...
  fromJSON(object: any): MsgRecoverMorseAccount {
    return {
      ...
      shannonDestAddress: isSet(object.shannonDestAddress)
        ...
        ? globalThis.String(object.shannon_dest_address)
        : "",
      morseSrcAddress: isSet(object.morseSrcAddress)
        ? globalThis.String(object.morseSrcAddress)
        : isSet(object.morse_src_address)
        ? globalThis.String(object.morse_src_address)
        : "",
    };
  },
...
function createBaseMsgAdminRecoverMorseAccount(): MsgAdminRecoverMorseAccount {
  return { authority: "", shannonDestAddress: "", morseSrcAddress: "" };
}

export const MsgAdminRecoverMorseAccount: MessageFns<MsgAdminRecoverMorseAccount> = {
  encode(message: MsgAdminRecoverMorseAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.shannonDestAddress !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgAdminRecoverMorseAccount {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgAdminRecoverMorseAccount();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): MsgAdminRecoverMorseAccount {
    return {
      authority: isSet(object.authority) ? globalThis.String(object.authority) : "",
      shannonDestAddress: isSet(object.shannonDestAddress)
        ? globalThis.String(object.shannonDestAddress)
  ...
  toJSON(message: MsgAdminRecoverMorseAccount): unknown {
    const obj: any = {};
    if (message.authority !== "") {
      obj.authority = message.authority;
    }
  ...
  create<I extends Exact<DeepPartial<MsgAdminRecoverMorseAccount>, I>>(base?: I): MsgAdminRecoverMorseAccount {
    return MsgAdminRecoverMorseAccount.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAdminRecoverMorseAccount>, I>>(object: I): MsgAdminRecoverMorseAccount {
    const message = createBaseMsgAdminRecoverMorseAccount();
    message.authority = object.authority ?? "";
    message.shannonDestAddress = object.shannonDestAddress ?? "";
    message.morseSrcAddress = object.morseSrcAddress ?? "";
...
function createBaseMsgAdminRecoverMorseAccountResponse(): MsgAdminRecoverMorseAccountResponse {
  return {};
}

export const MsgAdminRecoverMorseAccountResponse: MessageFns<MsgAdminRecoverMorseAccountResponse> = {
  encode(_: MsgAdminRecoverMorseAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgAdminRecoverMorseAccountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgAdminRecoverMorseAccountResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): MsgAdminRecoverMorseAccountResponse {
    return {};
  },

  toJSON(_: MsgAdminRecoverMorseAccountResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgAdminRecoverMorseAccountResponse>, I>>(
    base?: I,
  ): MsgAdminRecoverMorseAccountResponse {
    return MsgAdminRecoverMorseAccountResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAdminRecoverMorseAccountResponse>, I>>(
    _: I,
  ): MsgAdminRecoverMorseAccountResponse {
    const message = createBaseMsgAdminRecoverMorseAccountResponse();
    return message;
...
export interface Msg {
  ...
  AdminRecoverMorseAccount(request: MsgAdminRecoverMorseAccount): Promise<MsgAdminRecoverMorseAccountResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.AdminRecoverMorseAccount = this.AdminRecoverMorseAccount.bind(this);
  }
  UpdateParams(request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> {
  ...
  AdminRecoverMorseAccount(request: MsgAdminRecoverMorseAccount): Promise<MsgAdminRecoverMorseAccountResponse> {
    const data = MsgAdminRecoverMorseAccount.encode(request).finish();
    const promise = this.rpc.request(this.service, "AdminRecoverMorseAccount", data);
    return promise.then((data) => MsgAdminRecoverMorseAccountResponse.decode(new BinaryReader(data)));
  }
}
