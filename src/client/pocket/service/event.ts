  ...
  fromJSON(object: any): EventRelayMiningDifficultyUpdated {
    return {
      ...
      prevTargetHashHexEncoded: isSet(object.prevTargetHashHexEncoded)
        ...
        : isSet(object.prev_target_hash_hex_encoded)
        ? globalThis.String(object.prev_target_hash_hex_encoded)
        : "",
      newTargetHashHexEncoded: isSet(object.newTargetHashHexEncoded)
        ? globalThis.String(object.newTargetHashHexEncoded)
        : isSet(object.new_target_hash_hex_encoded)
        ? globalThis.String(object.new_target_hash_hex_encoded)
        : "",
      prevNumRelaysEma: isSet(object.prevNumRelaysEma)
        ? globalThis.Number(object.prevNumRelaysEma)
        : isSet(object.prev_num_relays_ema)
        ? globalThis.Number(object.prev_num_relays_ema)
        : 0,
      newNumRelaysEma: isSet(object.newNumRelaysEma)
        ? globalThis.Number(object.newNumRelaysEma)
        : isSet(object.new_num_relays_ema)
        ? globalThis.Number(object.new_num_relays_ema)
        : 0,
    };
  },
