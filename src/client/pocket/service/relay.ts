  ...
  fromJSON(object: any): RelayResponse {
    return {
      ...
      payloadHash: isSet(object.payloadHash)
        ...
        : new Uint8Array(0),
      relayMinerError: isSet(object.relayMinerError)
        ? RelayMinerError.fromJSON(object.relayMinerError)
        : isSet(object.relay_miner_error)
        ? RelayMinerError.fromJSON(object.relay_miner_error)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): RelayResponseMetadata {
    return {
      ...
      supplierOperatorSignature: isSet(object.supplierOperatorSignature)
        ...
        : isSet(object.supplier_operator_signature)
        ? bytesFromBase64(object.supplier_operator_signature)
        : new Uint8Array(0),
    };
  },
