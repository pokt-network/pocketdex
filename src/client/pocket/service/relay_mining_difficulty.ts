 ...
 */
export interface RelayMiningDifficultyUpdate {
  /**
  ...
  difficulty: RelayMiningDifficulty | undefined;
}
  ...
  fromJSON(object: any): RelayMiningDifficulty {
    return {
      ...
      blockHeight: isSet(object.blockHeight)
        ...
        : 0,
      numRelaysEma: isSet(object.numRelaysEma)
        ? globalThis.Number(object.numRelaysEma)
        : isSet(object.num_relays_ema)
        ? globalThis.Number(object.num_relays_ema)
        : 0,
      targetHash: isSet(object.targetHash)
        ? bytesFromBase64(object.targetHash)
        : isSet(object.target_hash)
        ? bytesFromBase64(object.target_hash)
        : new Uint8Array(0),
    };
  },
...
function createBaseRelayMiningDifficultyUpdate(): RelayMiningDifficultyUpdate {
  return { effectiveHeight: 0, difficulty: undefined };
}

export const RelayMiningDifficultyUpdate: MessageFns<RelayMiningDifficultyUpdate> = {
  encode(message: RelayMiningDifficultyUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.effectiveHeight !== 0) {
      writer.uint32(8).int64(message.effectiveHeight);
    }
    if (message.difficulty !== undefined) {
      RelayMiningDifficulty.encode(message.difficulty, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RelayMiningDifficultyUpdate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRelayMiningDifficultyUpdate();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.difficulty = RelayMiningDifficulty.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RelayMiningDifficultyUpdate {
    return {
      effectiveHeight: isSet(object.effectiveHeight)
        ...
        : 0,
      difficulty: isSet(object.difficulty) ? RelayMiningDifficulty.fromJSON(object.difficulty) : undefined,
    };
  },

  toJSON(message: RelayMiningDifficultyUpdate): unknown {
    const obj: any = {};
    if (message.effectiveHeight !== 0) {
      obj.effectiveHeight = Math.round(message.effectiveHeight);
    }
    if (message.difficulty !== undefined) {
      obj.difficulty = RelayMiningDifficulty.toJSON(message.difficulty);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RelayMiningDifficultyUpdate>, I>>(base?: I): RelayMiningDifficultyUpdate {
    return RelayMiningDifficultyUpdate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RelayMiningDifficultyUpdate>, I>>(object: I): RelayMiningDifficultyUpdate {
    const message = createBaseRelayMiningDifficultyUpdate();
    message.effectiveHeight = object.effectiveHeight ?? 0;
    message.difficulty = (object.difficulty !== undefined && object.difficulty !== null)
      ? RelayMiningDifficulty.fromPartial(object.difficulty)
      : undefined;
    return message;
  },
};
