  ...
  fromJSON(object: any): EventClaimExpired {
    return {
      expirationReason: isSet(object.expirationReason)
        ? claimExpirationReasonFromJSON(object.expirationReason)
        : isSet(object.expiration_reason)
        ? claimExpirationReasonFromJSON(object.expiration_reason)
        : 0,
      numRelays: isSet(object.numRelays)
        ? globalThis.Number(object.numRelays)
        : isSet(object.num_relays)
        ? globalThis.Number(object.num_relays)
        : 0,
      numClaimedComputeUnits: isSet(object.numClaimedComputeUnits)
        ? globalThis.Number(object.numClaimedComputeUnits)
        : isSet(object.num_claimed_compute_units)
        ? globalThis.Number(object.num_claimed_compute_units)
        : 0,
      numEstimatedComputeUnits: isSet(object.numEstimatedComputeUnits)
        ? globalThis.Number(object.numEstimatedComputeUnits)
        : isSet(object.num_estimated_compute_units)
        ? globalThis.Number(object.num_estimated_compute_units)
        : 0,
      claimedUpokt: isSet(object.claimedUpokt)
        ? globalThis.String(object.claimedUpokt)
        : isSet(object.claimed_upokt)
        ? globalThis.String(object.claimed_upokt)
        : "",
      serviceId: isSet(object.serviceId)
        ...
        : "",
      applicationAddress: isSet(object.applicationAddress)
        ? globalThis.String(object.applicationAddress)
        : isSet(object.application_address)
        ? globalThis.String(object.application_address)
        : "",
      sessionEndBlockHeight: isSet(object.sessionEndBlockHeight)
        ? globalThis.Number(object.sessionEndBlockHeight)
        : isSet(object.session_end_block_height)
        ? globalThis.Number(object.session_end_block_height)
        : 0,
      claimProofStatusInt: isSet(object.claimProofStatusInt)
        ? globalThis.Number(object.claimProofStatusInt)
        : isSet(object.claim_proof_status_int)
        ? globalThis.Number(object.claim_proof_status_int)
        : 0,
      supplierOperatorAddress: isSet(object.supplierOperatorAddress)
        ? globalThis.String(object.supplierOperatorAddress)
        : isSet(object.supplier_operator_address)
        ? globalThis.String(object.supplier_operator_address)
        : "",
    };
  },
...
export const EventClaimSettled: MessageFns<EventClaimSettled> = {
  encode(message: EventClaimSettled, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.rewardDistribution).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): EventClaimSettled {
    return {
      proofRequirementInt: isSet(object.proofRequirementInt)
        ? globalThis.Number(object.proofRequirementInt)
        : isSet(object.proof_requirement_int)
        ? globalThis.Number(object.proof_requirement_int)
        : 0,
      numRelays: isSet(object.numRelays)
        ? globalThis.Number(object.numRelays)
        : isSet(object.num_relays)
      ...
      rewardDistribution: isObject(object.rewardDistribution)
        ? (globalThis.Object.entries(object.rewardDistribution) as [string, any][]).reduce(
        ...
        : isObject(object.reward_distribution)
        ? (globalThis.Object.entries(object.reward_distribution) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: EventClaimSettled): unknown {
    ...
    if (message.rewardDistribution) {
      const entries = globalThis.Object.entries(message.rewardDistribution) as [string, string][];
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<EventClaimSettled>, I>>(object: I): EventClaimSettled {
    ...
    message.claimProofStatusInt = object.claimProofStatusInt ?? 0;
    message.supplierOperatorAddress = object.supplierOperatorAddress ?? "";
    message.rewardDistribution = (globalThis.Object.entries(object.rewardDistribution ?? {}) as [string, string][])
...
export const EventApplicationOverserviced: MessageFns<EventApplicationOverserviced> = {
  ...
  fromJSON(object: any): EventApplicationOverserviced {
    return {
      applicationAddr: isSet(object.applicationAddr)
        ? globalThis.String(object.applicationAddr)
        : isSet(object.application_addr)
        ? globalThis.String(object.application_addr)
        : "",
      supplierOperatorAddr: isSet(object.supplierOperatorAddr)
        ? globalThis.String(object.supplierOperatorAddr)
        : isSet(object.supplier_operator_addr)
        ? globalThis.String(object.supplier_operator_addr)
        : "",
      expectedBurn: isSet(object.expectedBurn)
        ? globalThis.String(object.expectedBurn)
        : isSet(object.expected_burn)
        ? globalThis.String(object.expected_burn)
        : "",
      effectiveBurn: isSet(object.effectiveBurn)
        ? globalThis.String(object.effectiveBurn)
        : isSet(object.effective_burn)
        ? globalThis.String(object.effective_burn)
        : "",
    };
  },
...
export const EventSupplierSlashed: MessageFns<EventSupplierSlashed> = {
  ...
  fromJSON(object: any): EventSupplierSlashed {
    return {
      proofMissingPenalty: isSet(object.proofMissingPenalty)
        ? globalThis.String(object.proofMissingPenalty)
        : isSet(object.proof_missing_penalty)
        ? globalThis.String(object.proof_missing_penalty)
        : "",
      serviceId: isSet(object.serviceId)
        ? globalThis.String(object.serviceId)
        : isSet(object.service_id)
  ...
  fromJSON(object: any): EventApplicationReimbursementRequest {
    return {
      ...
      supplierOperatorAddr: isSet(object.supplierOperatorAddr)
        ...
        ? globalThis.String(object.supplier_operator_addr)
        : "",
      supplierOwnerAddr: isSet(object.supplierOwnerAddr)
        ? globalThis.String(object.supplierOwnerAddr)
        : isSet(object.supplier_owner_addr)
        ? globalThis.String(object.supplier_owner_addr)
        : "",
      serviceId: isSet(object.serviceId)
        ? globalThis.String(object.serviceId)
        : isSet(object.service_id)
