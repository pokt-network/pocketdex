...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.mintRatio !== 0) {
      writer.uint32(73).double(message.mintRatio);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.mintRatio = reader.double();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Params {
    return {
      daoRewardAddress: isSet(object.daoRewardAddress)
        ? globalThis.String(object.daoRewardAddress)
        : isSet(object.dao_reward_address)
        ? globalThis.String(object.dao_reward_address)
        : "",
      mintAllocationPercentages: isSet(object.mintAllocationPercentages)
        ...
        : isSet(object.mint_allocation_percentages)
        ? MintAllocationPercentages.fromJSON(object.mint_allocation_percentages)
        : undefined,
      globalInflationPerClaim: isSet(object.globalInflationPerClaim)
        ? globalThis.Number(object.globalInflationPerClaim)
        : isSet(object.global_inflation_per_claim)
        ? globalThis.Number(object.global_inflation_per_claim)
        : 0,
      mintEqualsBurnClaimDistribution: isSet(object.mintEqualsBurnClaimDistribution)
        ...
        : isSet(object.mint_equals_burn_claim_distribution)
        ? MintEqualsBurnClaimDistribution.fromJSON(object.mint_equals_burn_claim_distribution)
        : undefined,
      mintRatio: isSet(object.mintRatio)
        ? globalThis.Number(object.mintRatio)
        : isSet(object.mint_ratio)
        ? globalThis.Number(object.mint_ratio)
        : 0,
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.mintRatio !== 0) {
      obj.mintRatio = message.mintRatio;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.mintEqualsBurnClaimDistribution =
      (object.mintEqualsBurnClaimDistribution !== undefined && object.mintEqualsBurnClaimDistribution !== null)
        ...
        : undefined;
    message.mintRatio = object.mintRatio ?? 0;
    return message;
  },
};
...
export const MintAllocationPercentages: MessageFns<MintAllocationPercentages> = {
  ...
  fromJSON(object: any): MintAllocationPercentages {
    return {
      ...
      sourceOwner: isSet(object.sourceOwner)
        ? globalThis.Number(object.sourceOwner)
        : isSet(object.source_owner)
        ? globalThis.Number(object.source_owner)
        : 0,
