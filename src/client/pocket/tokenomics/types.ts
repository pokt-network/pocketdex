  ...
  fromJSON(object: any): ClaimSettlementResult {
    return {
      ...
      modToModTransfers: globalThis.Array.isArray(object?.modToModTransfers)
        ...
        : globalThis.Array.isArray(object?.mod_to_mod_transfers)
        ? object.mod_to_mod_transfers.map((e: any) => ModToModTransfer.fromJSON(e))
        : [],
      modToAcctTransfers: globalThis.Array.isArray(object?.modToAcctTransfers)
        ...
        : globalThis.Array.isArray(object?.mod_to_acct_transfers)
        ? object.mod_to_acct_transfers.map((e: any) => ModToAcctTransfer.fromJSON(e))
        : [],
    };
  },
...
export const MintBurnOp: MessageFns<MintBurnOp> = {
  ...
  fromJSON(object: any): MintBurnOp {
    return {
      opReason: isSet(object.opReason)
        ? settlementOpReasonFromJSON(object.opReason)
        : isSet(object.op_reason)
        ? settlementOpReasonFromJSON(object.op_reason)
        : 0,
