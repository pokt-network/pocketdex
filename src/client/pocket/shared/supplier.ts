  ...
  fromJSON(object: any): Supplier {
    return {
      ...
      serviceConfigHistory: globalThis.Array.isArray(object?.serviceConfigHistory)
        ...
        : globalThis.Array.isArray(object?.service_config_history)
        ? object.service_config_history.map((e: any) => ServiceConfigUpdate.fromJSON(e))
        : [],
    };
  },
...
export const ServiceConfigUpdate: MessageFns<ServiceConfigUpdate> = {
  ...
  fromJSON(object: any): ServiceConfigUpdate {
    return {
      ...
      activationHeight: isSet(object.activationHeight)
        ? globalThis.Number(object.activationHeight)
        : isSet(object.activation_height)
        ? globalThis.Number(object.activation_height)
        : 0,
      deactivationHeight: isSet(object.deactivationHeight)
        ? globalThis.Number(object.deactivationHeight)
        : isSet(object.deactivation_height)
        ? globalThis.Number(object.deactivation_height)
        : 0,
    };
  },
