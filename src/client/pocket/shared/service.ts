...
export interface Metadata {
   ...
   */
  experimentalApiSpecs: Uint8Array;
}

function createBaseService(): Service {
  return { id: "", name: "", computeUnitsPerRelay: 0, ownerAddress: "", metadata: undefined };
}
...
export const Service: MessageFns<Service> = {
  ...
  fromJSON(object: any): Service {
    return {
      ...
      computeUnitsPerRelay: isSet(object.computeUnitsPerRelay)
        ? globalThis.Number(object.computeUnitsPerRelay)
        : isSet(object.compute_units_per_relay)
        ? globalThis.Number(object.compute_units_per_relay)
        : 0,
  ...
  fromJSON(object: any): SupplierServiceConfig {
    return {
      ...
      revShare: globalThis.Array.isArray(object?.revShare)
        ...
        : globalThis.Array.isArray(object?.rev_share)
        ? object.rev_share.map((e: any) => ServiceRevenueShare.fromJSON(e))
        : [],
    };
  },
...
export const SupplierEndpoint: MessageFns<SupplierEndpoint> = {
  ...
  fromJSON(object: any): SupplierEndpoint {
    return {
      ...
      rpcType: isSet(object.rpcType)
        ? rPCTypeFromJSON(object.rpcType)
        : isSet(object.rpc_type)
        ? rPCTypeFromJSON(object.rpc_type)
        : 0,
...
export const ServiceRevenueShare: MessageFns<ServiceRevenueShare> = {
  ...
  fromJSON(object: any): ServiceRevenueShare {
    return {
      ...
      revSharePercentage: isSet(object.revSharePercentage)
        ? globalThis.Number(object.revSharePercentage)
        : isSet(object.rev_share_percentage)
        ? globalThis.Number(object.rev_share_percentage)
        : 0,
    };
  },
...
function createBaseMetadata(): Metadata {
  return { experimentalApiSpecs: new Uint8Array(0) };
}

export const Metadata: MessageFns<Metadata> = {
  encode(message: Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.experimentalApiSpecs.length !== 0) {
      writer.uint32(10).bytes(message.experimentalApiSpecs);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.experimentalApiSpecs = reader.bytes();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Metadata {
    return {
      experimentalApiSpecs: isSet(object.experimentalApiSpecs)
        ? bytesFromBase64(object.experimentalApiSpecs)
        : isSet(object.experimental_api_specs)
        ? bytesFromBase64(object.experimental_api_specs)
        : new Uint8Array(0),
    };
  },
  ...
  toJSON(message: Metadata): unknown {
    const obj: any = {};
    if (message.experimentalApiSpecs.length !== 0) {
      obj.experimentalApiSpecs = base64FromBytes(message.experimentalApiSpecs);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata>, I>>(object: I): Metadata {
    const message = createBaseMetadata();
    message.experimentalApiSpecs = object.experimentalApiSpecs ?? new Uint8Array(0);
    return message;
  },
};
