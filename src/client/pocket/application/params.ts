...
export const Params: MessageFns<Params> = {
  ...
  fromJSON(object: any): Params {
    return {
      maxDelegatedGateways: isSet(object.maxDelegatedGateways)
        ? globalThis.Number(object.maxDelegatedGateways)
        : isSet(object.max_delegated_gateways)
        ? globalThis.Number(object.max_delegated_gateways)
        : 0,
      minStake: isSet(object.minStake)
        ? Coin.fromJSON(object.minStake)
        : isSet(object.min_stake)
        ? Coin.fromJSON(object.min_stake)
        : undefined,
    };
  },
