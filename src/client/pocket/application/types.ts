...
export const Application: MessageFns<Application> = {
  encode(message: Application, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.pendingUndelegations).forEach(
      ([key, value]: [string, UndelegatingGatewayList]) => {
  ...
  fromJSON(object: any): Application {
    return {
      ...
      serviceConfigs: globalThis.Array.isArray(object?.serviceConfigs)
        ...
        ? object.service_configs.map((e: any) => ApplicationServiceConfig.fromJSON(e))
        : [],
      delegateeGatewayAddresses: globalThis.Array.isArray(object?.delegateeGatewayAddresses)
        ...
        : globalThis.Array.isArray(object?.delegatee_gateway_addresses)
        ? object.delegatee_gateway_addresses.map((e: any) => globalThis.String(e))
        : [],
      pendingUndelegations: isObject(object.pendingUndelegations)
        ? (globalThis.Object.entries(object.pendingUndelegations) as [string, any][]).reduce(
          (acc: { [key: number]: UndelegatingGatewayList }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = UndelegatingGatewayList.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.pending_undelegations)
        ? (globalThis.Object.entries(object.pending_undelegations) as [string, any][]).reduce(
          (acc: { [key: number]: UndelegatingGatewayList }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = UndelegatingGatewayList.fromJSON(value);
            return acc;
          },
      ...
      unstakeSessionEndHeight: isSet(object.unstakeSessionEndHeight)
        ...
        : isSet(object.unstake_session_end_height)
        ? globalThis.Number(object.unstake_session_end_height)
        : 0,
      pendingTransfer: isSet(object.pendingTransfer)
        ? PendingApplicationTransfer.fromJSON(object.pendingTransfer)
        : isSet(object.pending_transfer)
        ? PendingApplicationTransfer.fromJSON(object.pending_transfer)
        : undefined,
    };
  },
  ...
  toJSON(message: Application): unknown {
    ...
    if (message.pendingUndelegations) {
      const entries = globalThis.Object.entries(message.pendingUndelegations) as [string, UndelegatingGatewayList][];
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<Application>, I>>(object: I): Application {
    ...
    message.pendingUndelegations =
      (globalThis.Object.entries(object.pendingUndelegations ?? {}) as [string, UndelegatingGatewayList][]).reduce(
        (acc: { [key: number]: UndelegatingGatewayList }, [key, value]: [string, UndelegatingGatewayList]) => {
          if (value !== undefined) {
  ...
  fromJSON(object: any): UndelegatingGatewayList {
    return {
      gatewayAddresses: globalThis.Array.isArray(object?.gatewayAddresses)
        ...
        : globalThis.Array.isArray(object?.gateway_addresses)
        ? object.gateway_addresses.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): PendingUndelegation {
    return {
      ...
      gatewayAddress: isSet(object.gatewayAddress)
        ? globalThis.String(object.gatewayAddress)
        : isSet(object.gateway_address)
        ? globalThis.String(object.gateway_address)
        : "",
    };
  },
