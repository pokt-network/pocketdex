...
export const MsgDelegateToGateway: MessageFns<MsgDelegateToGateway> = {
  ...
  fromJSON(object: any): MsgDelegateToGateway {
    return {
      appAddress: isSet(object.appAddress)
        ? globalThis.String(object.appAddress)
        : isSet(object.app_address)
        ? globalThis.String(object.app_address)
        : "",
...
export const MsgUpdateParam: MessageFns<MsgUpdateParam> = {
  ...
  fromJSON(object: any): MsgUpdateParam {
    return {
      ...
      asUint64: isSet(object.asUint64)
        ? globalThis.Number(object.asUint64)
        : isSet(object.as_uint64)
        ? globalThis.Number(object.as_uint64)
        : undefined,
