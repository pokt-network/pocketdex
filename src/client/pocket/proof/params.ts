  ...
  fromJSON(object: any): Params {
    return {
      proofRequestProbability: isSet(object.proofRequestProbability)
        ...
        : isSet(object.proof_request_probability)
        ? globalThis.Number(object.proof_request_probability)
        : 0,
      proofRequirementThreshold: isSet(object.proofRequirementThreshold)
        ? Coin.fromJSON(object.proofRequirementThreshold)
        : isSet(object.proof_requirement_threshold)
        ? Coin.fromJSON(object.proof_requirement_threshold)
        : undefined,
      proofMissingPenalty: isSet(object.proofMissingPenalty)
        ? Coin.fromJSON(object.proofMissingPenalty)
        : isSet(object.proof_missing_penalty)
        ? Coin.fromJSON(object.proof_missing_penalty)
        : undefined,
      proofSubmissionFee: isSet(object.proofSubmissionFee)
        ? Coin.fromJSON(object.proofSubmissionFee)
        : isSet(object.proof_submission_fee)
        ? Coin.fromJSON(object.proof_submission_fee)
        : undefined,
    };
  },
