...
export const MsgUpdateParam: MessageFns<MsgUpdateParam> = {
  ...
  fromJSON(object: any): MsgUpdateParam {
    return {
      ...
      asBytes: isSet(object.asBytes)
        ? bytesFromBase64(object.asBytes)
        : isSet(object.as_bytes)
        ? bytesFromBase64(object.as_bytes)
        : undefined,
      asFloat: isSet(object.asFloat)
        ? globalThis.Number(object.asFloat)
        : isSet(object.as_float)
        ? globalThis.Number(object.as_float)
        : undefined,
  ...
  fromJSON(object: any): MsgCreateClaim {
    return {
      supplierOperatorAddress: isSet(object.supplierOperatorAddress)
        ...
        : "",
      sessionHeader: isSet(object.sessionHeader)
        ? SessionHeader.fromJSON(object.sessionHeader)
        : isSet(object.session_header)
        ? SessionHeader.fromJSON(object.session_header)
        : undefined,
