...
export function applicationUnbondingReasonFromJSON(object: any): ApplicationUnbondingReason {
  switch (object) {
    ...
    case "BELOW_MIN_STAKE":
      return ApplicationUnbondingReason.BELOW_MIN_STAKE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function applicationUnbondingReasonToJSON(object: ApplicationUnbondingReason): string {
  switch (object) {
    case ApplicationUnbondingReason.ELECTIVE:
      return "ELECTIVE";
    case ApplicationUnbondingReason.BELOW_MIN_STAKE:
      return "BELOW_MIN_STAKE";
