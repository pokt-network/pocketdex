...
function createBaseMsgUpdateParam(): MsgUpdateParam {
  return { authority: "", name: "", asString: undefined, asInt64: undefined, asBytes: undefined };
}
...
export const MsgUpdateParam: MessageFns<MsgUpdateParam> = {
  encode(message: MsgUpdateParam, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.asInt64 !== undefined) {
      writer.uint32(48).int64(message.asInt64);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.asInt64 = longToNumber(reader.int64());
          continue;
        case 7:
          if (tag !== 58) {
            break;
  ...
  fromJSON(object: any): MsgUpdateParam {
    return {
      ...
      asInt64: isSet(object.asInt64) ? globalThis.Number(object.asInt64) : undefined,
  ...
  toJSON(message: MsgUpdateParam): unknown {
    ...
    if (message.asInt64 !== undefined) {
      obj.asInt64 = Math.round(message.asInt64);
    }
    if (message.asBytes !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateParam>, I>>(object: I): MsgUpdateParam {
    ...
    message.asInt64 = object.asInt64 ?? undefined;
...
export const MsgServiceName = "poktroll.tokenomics.Msg";
